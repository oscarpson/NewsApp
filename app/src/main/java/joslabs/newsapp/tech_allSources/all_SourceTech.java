package joslabs.newsapp.tech_allSources;
...
public class all_SourceTech extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    private RecyclerView recyclerView;
    private List<all_Newsget> currentNews;
    private SwipeRefreshLayout swipeRefreshLayout;
    final static String MAIN_URL="https://newsapi.org/v1/sources?&category=technology&language=en&apiKey=7cb5932571df414b8d861a36d750bd08";
    private CoordinatorLayout coordinatorLayout;

    public all_SourceTech() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_all__source_tech, container, false);
                ...
                try {
                   ...
                   /* String kk=jsonObject.getString("status");
                    ...
                    for (int i=0;i<jsonArray.length();i++) {
                        ...
                        currentNews.add(new all_Newsget("","Source : "+jor.getString("name"),"Country "+jor.getString("country"),jor.getString("description"),jor.getString("url")));
                        // System.out.print("Image Url: "+jor.getString("photo_url"));

                        Log.d("newsData",jor.getString("urlsToLogos")+"\n"+jor.getString("name")+"\n"+jor.getString("country")+"\n"+jor.getString("description")+"\n"+jor.getString("url"));
