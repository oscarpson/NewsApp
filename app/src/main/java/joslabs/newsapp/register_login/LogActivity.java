...
public class LogActivity extends AppCompatActivity {
    ...
    Button btnsignup;
    final static String REGISTER_URL="http://joslabs.co.ke/hama/testlog.php";
...
//                        System.out.print("was here");
    ...
    private void registratiofail() {
        final AlertDialog dialog = new AlertDialog.Builder(LogActivity.this).create();
        dialog.setTitle("Fail");
        dialog.setMessage("Wrong credentials ..try again");
    ...
    private void showLoginSuceessDialog() {
        ...
        dialog.setMessage("Login was successful");
        dialog.setButton(AlertDialog.BUTTON_NEUTRAL, "OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                dialog.dismiss();
