package joslabs.newsapp.only_tech;
...
public class only_Technology extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    final static String MAIN_URL="https://newsapi.org/v1/articles?source=bbc-news&category=technology&apiKey=7cb5932571df414b8d861a36d750bd08";
    private CoordinatorLayout coordinatorLayout;

    public only_Technology() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_only__technology, container, false);
